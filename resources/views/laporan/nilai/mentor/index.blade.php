...
<div class="container-fluid py-4 bg-light min-vh-100"> {{-- Menggunakan bg-light dan min-vh-100 untuk latar belakang --}}
    ...
    @if ($courses->isNotEmpty())
        ...
        <div class="card shadow-sm border-0 mt-5 p-4"> {{-- Card untuk Aksi Cepat --}}
            <h3 class="h5 fw-bold text-dark mb-4 d-flex align-items-center">
                <svg class="bi text-primary me-2" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                </svg>
                Aksi Cepat
            </h3>
            <div class="row g-3"> {{-- Grid untuk tombol aksi --}}
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-light w-100 text-start py-3 d-flex align-items-center">
                        <svg class="bi text-primary me-3" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                        <span class="text-primary fw-medium">Tambah Kursus</span>
                    </button>
                </div>
                
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-light w-100 text-start py-3 d-flex align-items-center">
                        <svg class="bi text-success me-3" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <span class="text-success fw-medium">Export Laporan</span>
                    </button>
                </div>
                
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-light w-100 text-start py-3 d-flex align-items-center">
                        <svg class="bi text-info me-3" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"> {{-- Menggunakan text-info untuk warna ungu/biru --}}
                        ...
                        <span class="text-info fw-medium">Pengaturan</span>
                    </button>
                </div>
                
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-light w-100 text-start py-3 d-flex align-items-center">
                        <svg class="bi text-warning me-3" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"> {{-- Menggunakan text-warning untuk warna orange --}}
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span class="text-warning fw-medium">Bantuan</span>
                    </button>
                </div>
            </div>
        </div>
