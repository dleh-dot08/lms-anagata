...
<div class="container mt-4">
    <h2 class="mb-4">Detail Absensi Siswa</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <p><strong>Nama Siswa:</strong> {{ $attendance->user->name }}</p>
    ...
    <a href="{{ route('attendances.sekolah.index') }}" class="btn btn-secondary mt-4">Kembali</a>
</div>
@endsection